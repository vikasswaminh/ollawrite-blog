...
In 2026, the "best" AI writing tool depends entirely on what you're writing. ChatGPT and Claude have basically replaced most single-purpose AI writers for anyone who knows how to prompt well; Claude wins on natural tone and long-form flow, while ChatGPT wins on research and structure. Grammarly and ProWritingAid still own editing and polish. Jasper and Writer dominate brand-consistent enterprise content. Surfer SEO and Frase are for teams chasing rankings, not prose.
...
Before diving into individual platforms, teams that require automated domain grounding and brand voice consistency should evaluate [OllaWrite](https://www.ollawrite.com), an autonomous multi-agent platform engineered specifically for research-backed publishing.
...
Its biggest strength is flexibility. It can organize complex information clearly and follow detailed style instructions across longer conversations. When you feed ChatGPT a 15-point editorial brief with explicit negative constraints, such as avoiding clichés, banning overused transitions, and enforcing specific subhead structures, it adheres to those rules with remarkable discipline. Furthermore, its ability to analyze uploaded documents, parse CSV data sets, and extract structured arguments makes it an invaluable companion during the preliminary research phase of writing.
...
Claude is particularly strong at producing natural-sounding long-form content. Its writing tends to have more varied sentence structures and a conversational flow that can feel noticeably less formulaic than other LLMs.

It also performs exceptionally well with technical and complex subjects, making difficult topics easier to understand without oversimplifying them or resorting to corporate jargon. In our direct tests comparing long-form essays, Claude produced prose with superior cadence, authentic rhetorical nuance, and a natural human-like cadence that required significantly fewer line edits before publication.
...
Its biggest advantage is native ecosystem integration. Instead of constantly copying and pasting information between disparate applications, users can summon AI assistance directly inside the document or spreadsheet they are actively working in. Gemini can pull background context from your Google Drive files, summarize email threads in Gmail into actionable task lists, and cross-reference real-time web search results with live citations.
...
Writesonic focuses on producing structured, SEO-oriented content at scale. Its built-in optimization features make it useful for marketing teams that want real-time SEO guidance while drafting.

With its integrated keyword intelligence, automated SERP competitor analysis, and real-time content scoring, Writesonic allows content managers to generate search-optimized initial drafts quickly. Its research and live browsing capabilities also help ensure that factual claims are anchored to current web sources rather than stale training data.
...
Copy.ai has expanded far beyond simple copy generation into full marketing workflow automation.

It is particularly useful for repetitive marketing tasks such as creating bulk ad variations, automated email nurture sequences, e-commerce product descriptions, and multi-channel campaign assets. Rather than generating one piece of text at a time, Copy.ai enables teams to construct multi-step workflows that pull company information, draft copy against established brand guidelines, and export the results directly into downstream marketing tools.
...
Grammarly is primarily an editing and writing-assistance tool rather than a traditional generative content platform.

Its undisputed strength is real-time grammar, clarity, spelling, conciseness, and tone assistance across web browsers, desktop apps, email clients, and word processors. Rather than generating text from scratch, Grammarly acts as an omnipresent editorial assistant that catches punctuation errors, flags passive voice, suggests tighter phrasing, and ensures that company-wide style guide rules are maintained everywhere your team writes.
...
ProWritingAid is designed for detailed developmental and copy editing rather than rapid text generation.

It provides comprehensive analysis of sentence length variety, pacing, repeated words, readability scores, sticky sentences, and stylistic clichés. This makes it extraordinarily useful for long-form writing, academic papers, and full-length book manuscripts where stylistic consistency over thousands of words is difficult to evaluate manually.
...
Surfer SEO is an optimization and content intelligence platform rather than a standalone generative writing tool.

It reverse-engineers the top-ranking search engine results for your target query, analyzing word count, heading structures, NLP entities, and keyword frequency. As you write or paste your draft into its Content Editor, Surfer provides a dynamic real-time score indicating how closely your document aligns with the structural patterns of currently ranking pages.
...
Frase focuses heavily on the preliminary research, question analysis, and content planning stages of the writing workflow.

By crawling the live SERP for any keyword, Frase automatically identifies common subheadings, frequently asked questions on Reddit and Quora, and structural gaps among competing articles. It then compiles these insights into a comprehensive, structured content brief that human writers or AI drafters can follow with precision.
...
Notion AI works directly inside Notion, making it extraordinarily useful for teams that already use Notion for documentation, company wikis, project management, and content planning.

Its main advantage is unmatched workflow convenience. Users can brainstorm ideas, draft blog outlines, summarize meeting transcripts, extract action items, and translate documentation without ever leaving their central project workspace or switching browser tabs.
...
Sudowrite is designed specifically for creative writing, narrative fiction, and world-building.

Unlike general AI chatbots that default to corporate essay structures, Sudowrite understands story arcs, character development, sensory descriptions, dialogue cadence, and narrative pacing. Its specialized creative features, including "Describe" for multi-sensory immersion, "Brainstorm" for unexpected plot twists, and "Expand" for unblocking scenes, make it the premier tool for overcoming creative writer's block.
...
Novel Crafter focuses on organizing large, multi-chapter fiction projects while providing context-aware AI writing assistance.

Its standout capability is the Codex, an integrated narrative database that stores detailed profiles of characters, locations, lore, magic systems, and timeline events. When drafting a scene, Novel Crafter automatically feeds relevant Codex entries into the AI prompt, preventing inconsistencies such as changing a character's backstory or misremembering an established plot detail from twenty chapters earlier.
...
Rytr is a simple, lightweight, and budget-friendly writing assistant tailored for short-form copy and everyday business communication.
...
Anyword specializes in predictive performance scoring and copy intelligence for digital marketers and growth teams.
...
Writer is an enterprise-grade AI writing and content governance platform built specifically for large organizations with strict security, compliance, and brand consistency standards.
...
QuillBot and Wordtune are specialized sentence refinement and rewriting tools designed to enhance existing text rather than generate full articles from scratch.

QuillBot excels at paraphrasing, vocabulary expansion, and summarizing dense academic or technical passages. Wordtune focuses on micro-level sentence improvements, offering alternative phrasings, tone adjustments (formal vs. casual), and concise sentence shortening right inside your browser.
...
For the vast majority of content writers, bloggers, and marketing teams, Claude or ChatGPT will handle 80% to 90% of all drafting and brainstorming requirements. Adding Grammarly for real-time proofreading and Surfer SEO or Frase for search intent optimization creates a lean, highly effective modern publishing stack.
...
Second, actively inject your own firsthand experiences, specific case studies, concrete numbers, original screenshots, and contrarian perspectives. These unique details are impossible for an AI model to generate on its own because they exist outside its training data. They transform generic industry consensus into authoritative, memorable thought leadership.

Third, intentionally vary your sentence structures and paragraph lengths. Language models naturally gravitate toward a predictable medium length across sentences. Introducing punchy one-sentence paragraphs alongside detailed explanatory blocks creates a dynamic reading cadence that feels authentically human.

AI should handle the mechanical research and drafting heavy lifting. The final voice, nuance, and editorial conviction must always come from you.

## The Mistakes People Keep Making with AI Writing Tools

A few recurring mistakes continue to derail AI content strategies in 2026, and naming them directly helps you avoid costly errors:

- **Mistake 1: Publishing Raw First Output Without Editorial Review**: Because modern LLMs produce grammatically flawless text, it is dangerously easy to mistake syntactic polish for substantive value. Unedited drafts often sound convincing while lacking specific evidence, real examples, or containing subtle factual inaccuracies.
- **Mistake 2: Overpaying for Niche Software When General Models Suffice**: Spending $50, $200/month on specialized wrapper apps when a properly prompted Claude or ChatGPT session already solves the problem with better context and flexibility. Test general models with clear constraints first before committing to enterprise subscriptions.
- **Mistake 3: Prompting Vaguely and Blaming the AI for Generic Results**: Asking for "a blog post about SEO" produces boilerplate filler because the model lacks constraints. Feeding it your specific audience, unique data, counter-intuitive angles, and explicit negative instructions transforms output quality immediately.
- **Mistake 4: Ignoring AI Detectability and Brand Reputation**: In competitive search rankings, academic settings, and selective editorial publications, generic machine-generated filler carries real algorithmic and reputational penalties. Treating humanization and authentic voice as mandatory quality gates protects your domain trust.
- **Mistake 5: Failing to Fact-Check Specific Claims and Statistics**: Language models generate statistically plausible continuations, not verified facts. Skipping the verification step for numbers, dates, source attributions, and technical steps is how embarrassing inaccuracies get published under your name.

## Where This Is All Heading

Several emerging technological shifts will redefine the AI writing landscape over the next 12 to 24 months.

First, deep contextual personalization is becoming standard. Rather than requiring users to paste detailed style guidelines into every prompt, next-generation tools continuously learn an individual author's or brand's voice across published archives, automatically applying preferred terminology, cadence, and formatting rules.

Second, autonomous multi-agent editing pipelines are replacing single-pass generation. Instead of a single model drafting a post and immediately presenting it as complete, advanced systems now employ dedicated critic agents that independently fact-check claims, verify links against live sources, and reject unsubstantiated assertions before a human editor ever reviews the document.

Third, source grounding and real-time citation transparency are becoming mandatory for serious publishing. Tools that cite verified sources and verify claims against live sitemaps solve the fundamental trust problem of generative AI, ensuring that published content builds lasting domain authority rather than generic noise.
...
</div>`}],ye={"Humanizing AI":{bg:`#fdf2f8`,text:`#db2777`,accent:`#003db3`},"Site-First AI":{bg:`#fdf2f8`,text:`#db2777`,accent:`#e8443a`},"Multi-Agent AI":{bg:`#fdf2f8`,text:`#db2777`,accent:`#003db3`},"Editorial QA":{bg:`#fdf2f8`,text:`#db2777`,accent:`#16a34a`},"SEO Strategy":{bg:`#fdf2f8`,text:`#db2777`,accent:`#003db3`},"Content Generation":{bg:`#fdf2f8`,text:`#db2777`,accent:`#003db3`},"AI Search":{bg:`#fdf2f8`,text:`#db2777`,accent:`#003db3`}},be={bg:`#fdf2f8`,text:`#db2777`,accent:`#003db3`};function xe(e){return e&&ye[e]||be}var Se=[`#003db3`,`#e8443a`,`#475569`,`#16a34a`];function Ce(e){return Se[(e%Se.length+Se.length)%Se.length]}var we=({articles:e,onReadArticle:t})=>{let n=[...e].sort((e,t)=>new Date(t.publishedDate).getTime()-new Date(e.publishedDate).getTime()),r=n[0],i=n.slice(1),a=n=>{let r=e.find(e=>e.title.toLowerCase().includes(n.toLowerCase().slice(0,15)));r?t(r):e[0]&&t(e[0])};return(0,A.jsxs)(`div`,{className:`w-full mx-auto px-[2cm] py-6 font-['Lato'] text-slate-800 bg-white`,children:[(0,A.jsxs)(`div`,{className:`lg:hidden space-y-6 mb-8`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`div`,{className:`flex items-center gap-2 mb-3`,children:(0,A.jsx)(`span`,{className:`px-3.5 py-1.5 text-xs sm:text-sm font-bold rounded-full font-mono`,style:{backgroundColor:`#003db3`,color:`#ffffff`},children:`Essential Guide`})}),(0,A.jsx)(`div`,{className:`flex gap-3.5 overflow-x-auto pb-2 -mx-4 px-4 snap-x`,children:he.slice(0,5).map((e,t)=>(0,A.jsx)(`button`,{onClick:()=>a(e),className:`snap-start shrink-0 w-72 p-4 bg-slate-50 border border-slate-200 rounded-xl text-left cursor-pointer hover:border-[#003db3]`,children:(0,A.jsx)(`h3`,{className:`font-bold text-[15px] sm:text-base text-slate-900 line-clamp-2 leading-snug font-['Lato']`,children:e})},t))})]}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`div`,{className:`flex items-center gap-2 mb-3`,children:(0,A.jsx)(`span`,{className:`px-3.5 py-1.5 text-xs sm:text-sm font-bold text-white rounded-full font-mono`,style:{backgroundColor:`#e8443a`},children:`Agent Workflow`})}),(0,A.jsx)(`div`,{className:`flex gap-3.5 overflow-x-auto pb-2 -mx-4 px-4 snap-x`,children:ge.slice(0,5).map((e,t)=>(0,A.jsx)(`button`,{onClick:()=>a(e),className:`snap-start shrink-0 w-72 p-4 bg-slate-50 border border-slate-200 rounded-xl text-left cursor-pointer hover:border-[#e8443a]`,children:(0,A.jsx)(`h3`,{className:`font-bold text-[15px] sm:text-base text-slate-900 line-clamp-2 leading-snug font-['Lato']`,children:e})},t))})]})]}),(0,A.jsxs)(`div`,{className:`flex gap-6 xl:gap-8`,children:[(0,A.jsx)(`aside`,{className:`hidden lg:block w-[240px] shrink-0`,children:(0,A.jsxs)(`div`,{className:`sticky top-20 rounded-2xl border border-[#f1f5f9] bg-white/60 p-3.5`,children:[(0,A.jsx)(`div`,{className:`flex items-center gap-2 mb-3`,children:(0,A.jsx)(`span`,{className:`px-2.5 py-1 text-xs font-bold rounded-full font-mono`,style:{backgroundColor:`#003db3`,color:`#ffffff`},children:`Essential Guide`})}),(0,A.jsx)(`nav`,{className:`space-y-1`,children:he.map((e,t)=>(0,A.jsx)(`button`,{onClick:()=>a(e),className:`w-full text-left block px-2.5 py-1.5 text-[13px] font-bold text-slate-700 hover:text-[#003db3] hover:bg-[#eef4ff] rounded-lg transition-colors leading-snug cursor-pointer font-['Lato']`,children:(0,A.jsx)(`span`,{children:e})},t))}),(0,A.jsxs)(`div`,{className:`pt-3 mt-3 border-t border-slate-200 flex flex-col gap-1.5`,children:[(0,A.jsx)(`a`,{href:`https://ollawrite.com`,target:`_blank`,rel:`noopener noreferrer`,className:`os-toc-link block w-full text-left px-2.5 py-1.5 text-[13px] font-bold text-[#003db3] hover:bg-[#eef4ff] rounded-lg transition-colors leading-snug`,children:`OllaWrite AI Platform ↗`}),(0,A.jsx)(`a`,{href:`https://ollawrite.com/#features`,target:`_blank`,rel:`noopener noreferrer`,className:`os-toc-link block w-full text-left px-2.5 py-1.5 text-[13px] font-bold text-[#003db3] hover:bg-[#eef4ff] rounded-lg transition-colors leading-snug`,children:`Site-First Writing Engine ↗`}),(0,A.jsx)(`a`,{href:`https://ollawrite.com/#pricing`,target:`_blank`,rel:`noopener noreferrer`,className:`os-toc-link block w-full text-left px-2.5 py-1.5 text-[13px] font-bold text-[#003db3] hover:bg-[#eef4ff] rounded-lg transition-colors leading-snug`,children:`Plans & Pricing Overview ↗`})]}),(0,A.jsxs)(`button`,{onClick:()=>a(`Humanize`),className:`og-readmore inline-flex items-center mt-3 px-2 text-xs font-mono cursor-pointer gap-1.5 hover:underline`,children:[(0,A.jsx)(`span`,{children:`EXPLORE_FULL_INDEX`}),(0,A.jsx)(re,{size:14})]})]})}),(0,A.jsxs)(`div`,{className:`flex-1 min-w-0`,children:[(0,A.jsxs)(`div`,{className:`mb-6`,children:[(0,A.jsx)(`h1`,{className:`text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight leading-tight font-['Lato']`,children:`OllaWrite Insights: Grounded AI Research & Editorial Guides`}),(0,A.jsx)(`p`,{className:`text-sm sm:text-base text-slate-600 mt-2 font-normal leading-relaxed font-['Lato']`,children:`Expert-led guides on AI content optimization, search strategy, and the future of grounded intelligence.`})]}),(0,A.jsxs)(`section`,{className:`mb-10`,children:[(0,A.jsxs)(`div`,{className:`flex items-center gap-3 mb-4`,children:[(0,A.jsxs)(`div`,{className:`flex items-center gap-2 px-3 py-1 rounded-full`,style:{backgroundColor:`#ede9fe`,color:`#7c3aed`},children:[(0,A.jsx)(ce,{className:`w-4 h-4 text-[#7c3aed]`}),(0,A.jsx)(`h2`,{className:`text-xs sm:text-sm font-bold uppercase tracking-wide font-['Lato']`,children:`Newest Article`})]}),(0,A.jsx)(`span`,{className:`text-xs sm:text-sm text-slate-500 font-medium`,children:`Live telemetry from 10 autonomous engines`})]}),r&&(0,A.jsx)(`div`,{onClick:()=>t(r),className:`block mb-5 group cursor-pointer`,children:(0,A.jsxs)(`div`,{className:`relative overflow-hidden rounded-xl border border-slate-200 hover:shadow-md transition-all flex flex-col md:flex-row bg-white`,children:[(0,A.jsx)(`div`,{className:`md:w-[36%] aspect-[16/10] md:aspect-auto overflow-hidden bg-slate-100 min-h-[190px] group-hover:border-[#003db3]`,children:(0,A.jsx)(`img`,{src:r.imageUrl,alt:r.title,className:`w-full h-full object-cover group-hover:scale-105 transition-transform duration-300`,loading:`eager`})}),(0,A.jsxs)(`div`,{className:`md:w-[64%] p-4 sm:p-6 bg-slate-50/50 flex flex-col justify-between`,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`div`,{className:`flex items-center justify-between gap-2 mb-2.5`,children:(0,A.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,A.jsx)(`span`,{className:`inline-block text-xs font-mono px-2.5 py-0.5 rounded font-bold`,style:{backgroundColor:xe(r.category).bg,color:xe(r.category).text},children:r.category}),(0,A.jsx)(`span`,{className:`text-[11px] font-mono text-slate-400`,children:r.publishedDate})]})}),(0,A.jsx)(`h3`,{className:`text-lg sm:text-xl font-bold text-slate-900 leading-snug group-hover:text-[#003db3] transition-colors mb-2 font-['Lato']`,children:r.title}),(0,A.jsx)(`p`,{className:`text-xs sm:text-sm text-slate-600 line-clamp-2 mb-3 font-normal leading-relaxed font-['Lato']`,children:r.subtitle})]}),(0,A.jsx)(`div`,{className:`flex items-center justify-between text-xs text-slate-500 pt-2.5 border-t border-slate-200 font-mono font-medium`,children:(0,A.jsx)(`div`,{className:`flex items-center gap-3`,children:(0,A.jsx)(`span`,{children:r.readTime})})})]})]})}),(0,A.jsx)(`div`,{className:`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5`,children:i.map((e,n)=>(0,A.jsxs)(`article`,{onClick:()=>t(e),className:`border border-slate-200 bg-white rounded-lg transition-all group relative overflow-hidden hover:shadow-md cursor-pointer flex flex-col p-3.5`,onMouseEnter:t=>t.currentTarget.style.borderColor=xe(e.category).accent,onMouseLeave:e=>e.currentTarget.style.borderColor=``,children:[(0,A.jsx)(`div`,{className:`flex items-center gap-2 mb-2 font-mono`,children:(0,A.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,A.jsx)(`span`,{className:`inline-block text-xs px-2 py-0.5 rounded font-bold`,style:{backgroundColor:xe(e.category).bg,color:xe(e.category).text},children:e.category}),(0,A.jsx)(`span`,{className:`text-[11px] text-slate-400`,children:e.publishedDate})]})}),(0,A.jsx)(`h3`,{className:`text-sm font-bold text-slate-900 leading-snug transition-colors line-clamp-2 flex-1 font-['Lato'] mb-1.5 group-hover:text-[#003db3]`,children:e.title}),(0,A.jsx)(`p`,{className:`text-xs text-slate-600 line-clamp-2 mb-2.5 leading-relaxed font-normal font-['Lato']`,children:e.subtitle}),(0,A.jsx)(`div`,{className:`flex items-center justify-between text-xs text-slate-500 pt-2 border-t border-slate-100 font-mono font-medium`,children:(0,A.jsx)(`div`,{className:`flex items-center gap-3`,children:(0,A.jsx)(`span`,{children:e.readTime})})})]},e.id))})]})]}),(0,A.jsx)(`aside`,{className:`hidden lg:block w-[240px] shrink-0`,children:(0,A.jsxs)(`div`,{className:`sticky top-20 rounded-2xl border border-[#f1f5f9] bg-white/60 p-3.5`,children:[(0,A.jsx)(`div`,{className:`flex items-center gap-2 mb-3`,children:(0,A.jsx)(`span`,{className:`px-2.5 py-1 text-xs font-bold rounded-full font-mono`,style:{backgroundColor:`#ede9fe`,color:`#7c3aed`},children:`Agent Workflow`})}),(0,A.jsx)(`nav`,{className:`space-y-1`,children:ge.map((e,t)=>(0,A.jsx)(`button`,{onClick:()=>a(e),className:`w-full text-left block px-2.5 py-1.5 text-[13px] font-bold text-slate-700 hover:text-[#7c3aed] hover:bg-[#ede9fe] rounded-lg transition-colors leading-snug cursor-pointer font-['Lato']`,children:(0,A.jsx)(`span`,{children:e})},t))}),(0,A.jsxs)(`button`,{onClick:()=>a(`Site-First`),className:`inline-flex items-center mt-3 px-2 text-xs font-mono font-bold hover:underline cursor-pointer gap-1.5`,style:{color:`#7c3aed`},children:[(0,A.jsx)(`span`,{children:`EXPLORE_CITATION_INDEX`}),(0,A.jsx)(re,{size:14})]})]})})]})]})};function Te(e){if(!e)return``;let t=e;return t=t.replace(/((?:\|[^\n]+\|\n?)+)/g,e=>{let t=e.trim().split(`
`).filter(e=>e.trim().startsWith(`|`));if(t.length<2)return e;let n=t[0],r=t.slice(2),i=e=>e.split(`|`).slice(1,-1).map(e=>e.trim());return`<div class="overflow-x-auto my-6"><table class="prose-table"><thead><tr>${i(n).map(e=>`<th>${e}</th>`).join(``)}</tr></thead><tbody>${r.map(e=>`<tr>${i(e).map(e=>`<td>${e}</td>`).join(``)}</tr>`).join(``)}</tbody></table></div>`}),t=t.replace(/^## (.*$)/gim,(e,t)=>`<h2 id="${t.replace(/<[^>]+>/g,``).toLowerCase().replace(/[^a-z0-9]+/g,`-`)}" class="text-xl sm:text-2xl font-bold text-slate-900 mt-10 mb-4 font-['Lato']">${t}</h2>`),t=t.replace(/^### (.*$)/gim,(e,t)=>`<h3 id="${t.replace(/<[^>]+>/g,``).toLowerCase().replace(/[^a-z0-9]+/g,`-`)}" class="text-lg sm:text-xl font-bold text-slate-900 mt-8 mb-3 font-['Lato']">${t}</h3>`),t=t.replace(/^#### (.*$)/gim,(e,t)=>`<h4 id="${t.replace(/<[^>]+>/g,``).toLowerCase().replace(/[^a-z0-9]+/g,`-`)}" class="text-base font-bold text-slate-900 mt-5 mb-2 font-['Lato']">${t}</h4>`),t=t.replace(/\*\*(.*?)\*\*/g,`<strong>$1</strong>`),t=t.replace(/\*(.*?)\*/g,`<em>$1</em>`),t=t.replace(/\[([^\]]+)\]\(([^)]+)\)/g,`<a href="$2" target="_blank" rel="noopener noreferrer" class="text-[#003db3] underline hover:text-[#002d86] font-medium">$1</a>`),t=t.replace(/^> (.*$)/gim,`<blockquote class="pl-4 border-l-4 border-[#003db3] my-5 italic text-slate-700 bg-[#eef4ff]/60 py-3 px-4 rounded-r">$1</blockquote>`),t=t.replace(/^-\s+(.*$)/gim,`<li class="ml-4 list-disc text-slate-800 my-1">$1</li>`),t=t.replace(/^(\d+)\.\s+(.*$)/gim,`<li class="ml-4 list-decimal text-slate-800 my-1"><strong>$1.</strong> $2</li>`),t.split(/\n\n+/).map(e=>{let t=e.trim();return t?t.startsWith(`<div`)||t.startsWith(`<h`)||t.startsWith(`<table`)||t.startsWith(`<details`)||t.startsWith(`<blockquote`)||t.startsWith(`<li`)?t:`<p class="leading-relaxed mb-5 text-slate-800 font-['Lato'] text-base sm:text-lg">${t.replace(/\n/g,`<br/>`)}</p>`:``}).join(`
`)}var Ee=({article:e,onBack:t,onSelectArticle:n,allArticles:r})=>{let[i,a]=S.useState(!1);(0,S.useEffect)(()=>{window.scrollTo({top:0,behavior:`smooth`})},[e]);let o=r.filter(t=>t.id!==e.id).sort((e,t)=>new Date(t.publishedDate).getTime()-new Date(e.publishedDate).getTime()),s=o.slice(0,4),c=o.slice(4,8),l=[{title:`OllaWrite AI Platform ↗`,href:`https://ollawrite.com`},{title:`Site-First Writing Engine ↗`,href:`https://ollawrite.com/#features`},{title:`Plans & Pricing Overview ↗`,href:`https://ollawrite.com/#pricing`}],u=e.tags?.[0]||e.category||`Insights`;return(0,A.jsx)(`div`,{className:`w-full bg-white text-slate-900 font-['Lato'] min-h-screen py-8 px-4 sm:px-6 lg:px-12 animate-fade-in`,children:(0,A.jsxs)(`div`,{className:`max-w-[1560px] mx-auto`,children:[(0,A.jsxs)(`div`,{className:`flex flex-wrap items-center justify-between gap-4 mb-6 pb-4 border-b border-slate-200`,children:[(0,A.jsxs)(`nav`,{className:`flex items-center gap-2 text-sm text-slate-500 font-medium`,children:[(0,A.jsxs)(`button`,{onClick:t,className:`hover:text-[#002d86] transition cursor-pointer font-bold text-[#003db3] flex items-center gap-1`,children:[(0,A.jsx)(T,{size:16}),` Home`]}),(0,A.jsx)(`span`,{children:`/`}),(0,A.jsx)(`button`,{onClick:t,className:`hover:text-[#003db3] transition cursor-pointer`,children:`Blog`}),(0,A.jsx)(`span`,{children:`/`}),(0,A.jsx)(`span`,{className:`text-slate-900 font-semibold`,children:u})]}),(0,A.jsxs)(`button`,{onClick:()=>{navigator.clipboard.writeText(window.location.href),a(!0),setTimeout(()=>a(!1),2e3)},className:`flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-300 bg-slate-50 hover:bg-slate-100 text-slate-700 transition text-xs font-mono font-bold cursor-pointer`,children:[i?(0,A.jsx)(ie,{size:14,className:`text-emerald-600`}):(0,A.jsx)(D,{size:14}),(0,A.jsx)(`span`,{children:i?`COPIED_LINK`:`SHARE_ARTICLE`})]})]}),(0,A.jsxs)(`header`,{className:`post-header mb-10 pb-8 border-b border-slate-200`,children:[(0,A.jsxs)(`div`,{className:`post-meta-caption flex items-center gap-3 text-sm font-bold text-[#003db3] uppercase mb-4`,children:[(0,A.jsx)(`span`,{className:`px-3 py-1 rounded text-xs tracking-wider`,style:{backgroundColor:xe(e.category).bg,color:xe(e.category).text},children:u}),(0,A.jsx)(`span`,{children:`•`}),(0,A.jsx)(`span`,{className:`text-slate-500 font-semibold`,children:e.publishedDate}),(0,A.jsx)(`span`,{children:`•`}),(0,A.jsx)(`span`,{className:`text-slate-500 font-semibold`,children:e.readTime})]}),(0,A.jsx)(`h1`,{className:`os-display-title text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-900 leading-tight mb-4 font-['Lato']`,children:e.title}),e.subtitle&&(0,A.jsx)(`p`,{className:`os-lead-paragraph text-lg sm:text-xl text-slate-600 leading-relaxed mb-6 font-normal`,children:e.subtitle}),(0,A.jsxs)(`div`,{className:`author-hashtags-row flex flex-wrap items-center justify-between gap-4 pt-4 border-t border-slate-100`,children:[(0,A.jsxs)(`div`,{className:`author-info-group flex items-center gap-3`,children:[(0,A.jsx)(`div`,{className:`author-avatar-lightning w-10 h-10 rounded-full bg-[#eef4ff] border border-[#c7d8f8] flex items-center justify-center text-lg`,children:`⚡`}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`div`,{className:`author-title-name font-bold text-slate-900 text-base`,children:e.author.name}),(0,A.jsx)(`div`,{className:`author-subtitle-link text-xs text-slate-500`,children:e.author.role||`OllaWrite Content Architecture`})]})]}),(0,A.jsxs)(`div`,{className:`hashtags-group flex flex-wrap gap-2 text-sm font-semibold`,children:[(0,A.jsxs)(`span`,{style:{color:Ce(0)},children:[`#`,u.toLowerCase().replace(/[^a-z0-9]/g,``)]}),(0,A.jsx)(`span`,{style:{color:Ce(1)},children:`#aiwriting`}),(0,A.jsx)(`span`,{style:{color:Ce(2)},children:`#agenticAI`}),(0,A.jsx)(`span`,{style:{color:Ce(3)},children:`#contentstrategy`})]})]})]}),(0,A.jsxs)(`div`,{className:`blog-layout-grid grid grid-cols-1 lg:grid-cols-[270px_1fr_270px] gap-8 items-start`,children:[(0,A.jsxs)(`aside`,{className:`blog-sidebar sticky top-24 space-y-4`,children:[(0,A.jsx)(`span`,{className:`sidebar-title blue block text-xs font-bold uppercase tracking-wider text-white px-3 py-1.5 rounded-full w-max mb-3`,style:{backgroundColor:`#003db3`},children:`Essential Guides`}),(0,A.jsxs)(`div`,{className:`sidebar-cards-stack flex flex-col gap-2.5`,children:[s.map((e,t)=>(0,A.jsx)(`button`,{onClick:()=>n(e),className:`os-toc-link text-left w-full p-3 bg-white border border-slate-200 rounded-lg hover:bg-[#eef4ff]/60 text-slate-800 font-medium text-xs sm:text-sm transition cursor-pointer line-clamp-2`,onMouseEnter:e=>e.currentTarget.style.borderColor=Ce(t%4),onMouseLeave:e=>e.currentTarget.style.borderColor=``,children:e.title},e.id)),(0,A.jsx)(`div`,{className:`pt-3 border-t border-slate-200 flex flex-col gap-2`,children:l.map((e,t)=>(0,A.jsx)(`a`,{href:e.href,target:`_blank`,rel:`noopener noreferrer`,className:`os-toc-link block p-3 bg-slate-50 border border-slate-200 rounded-lg hover:border-[#003db3] text-[#003db3] font-bold text-xs sm:text-sm transition`,children:e.title},t))})]})]}),(0,A.jsx)(`main`,{className:`blog-main-column min-w-0`,children:(0,A.jsx)(`div`,{className:`prose text-slate-800 space-y-6 text-base sm:text-lg font-['Lato']`,dangerouslySetInnerHTML:{__html:Te(e.content)}})}),(0,A.jsxs)(`aside`,{className:`blog-sidebar sticky top-24 space-y-4`,children:[(0,A.jsx)(`span`,{className:`sidebar-title purple block text-xs font-bold uppercase tracking-wider text-white px-3 py-1.5 rounded-full w-max mb-3`,style:{backgroundColor:`#e8443a`},children:`Agent Workflows`}),(0,A.jsx)(`div`,{className:`sidebar-cards-stack flex flex-col gap-2.5`,children:c.map((e,t)=>(0,A.jsx)(`button`,{onClick:()=>n(e),className:`os-toc-link text-left w-full p-3 bg-white border border-slate-200 rounded-lg hover:bg-[#fdeceb]/60 text-slate-800 font-medium text-xs sm:text-sm transition cursor-pointer line-clamp-2`,onMouseEnter:e=>e.currentTarget.style.borderColor=Ce((t+2)%4),onMouseLeave:e=>e.currentTarget.style.borderColor=``,children:e.title},e.id))})]})]})]})})},De=({isOpen:e,onClose:t,articles:n,onSelectArticle:r})=>{let[i,a]=(0,S.useState)(``),o=(0,S.useRef)(null);if((0,S.useEffect)(()=>{e&&setTimeout(()=>o.current?.focus(),50)},[e]),(0,S.useEffect)(()=>{let e=e=>{e.key===`Escape`&&t()};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[t]),!e)return null;let s=i.trim()===``?[]:n.filter(e=>e.title.toLowerCase().includes(i.toLowerCase())||e.summary.toLowerCase().includes(i.toLowerCase())||e.category.toLowerCase().includes(i.toLowerCase())||(e.tags?.some(e=>e.toLowerCase().includes(i.toLowerCase()))??!1));return(0,A.jsx)(`div`,{className:`fixed inset-0 z-50 overflow-y-auto bg-slate-900/50 backdrop-blur-sm flex items-start justify-center pt-12 sm:pt-20 px-4 animate-fade-in font-['Lato']`,children:(0,A.jsxs)(`div`,{className:`bg-white rounded-2xl max-w-2xl w-full border border-slate-200 shadow-2xl overflow-hidden text-slate-900`,children:[(0,A.jsxs)(`div`,{className:`p-4 border-b border-slate-200 flex items-center gap-3 bg-slate-50`,children:[(0,A.jsx)(de,{className:`w-5 h-5 text-[#003db3] shrink-0`}),(0,A.jsx)(`input`,{ref:o,type:`text`,value:i,onChange:e=>a(e.target.value),placeholder:`QUERY_KNOWLEDGE_BASE (e.g. sitemap, multi-agent, SEO)...`,className:`w-full bg-transparent text-sm sm:text-base text-slate-900 placeholder-slate-400 focus:outline-none font-mono font-medium py-1`}),(0,A.jsx)(`button`,{onClick:t,className:`text-slate-400 hover:text-slate-700 p-1 rounded-lg hover:bg-slate-200 transition cursor-pointer`,children:(0,A.jsx)(fe,{size:18})})]}),i.trim()===``&&(0,A.jsxs)(`div`,{className:`p-5`,children:[(0,A.jsxs)(`div`,{className:`text-xs font-mono text-slate-500 uppercase tracking-wider mb-3 flex items-center gap-2 font-bold`,children:[(0,A.jsx)(se,{size:14,className:`text-[#003db3]`}),(0,A.jsx)(`span`,{children:`INDEXED_TOPIC_VECTORS`})]}),(0,A.jsx)(`div`,{className:`flex flex-wrap gap-2`,children:_e.map((e,t)=>{let n=Ce(t);return(0,A.jsxs)(`button`,{onClick:()=>a(e),className:`px-3 py-1.5 rounded-lg border bg-slate-50 text-xs font-mono font-semibold text-slate-700 transition cursor-pointer`,style:{borderColor:`${n}55`,color:n},onMouseEnter:e=>{e.currentTarget.style.backgroundColor=`${n}18`,e.currentTarget.style.borderColor=n},onMouseLeave:e=>{e.currentTarget.style.backgroundColor=``,e.currentTarget.style.borderColor=`${n}55`},children:[`> `,e]},e)})})]}),i.trim()!==``&&(0,A.jsx)(`div`,{className:`max-h-[380px] overflow-y-auto divide-y divide-slate-100 p-3`,children:s.length>0?s.map(e=>(0,A.jsxs)(`button`,{onClick:()=>{r(e),t()},className:`w-full text-left p-3.5 rounded-xl hover:bg-slate-50 transition flex items-center justify-between group cursor-pointer`,children:[(0,A.jsxs)(`div`,{className:`pr-3`,children:[(0,A.jsx)(`div`,{className:`flex items-center gap-2 text-xs font-mono mb-1`,children:(0,A.jsxs)(`span`,{className:`font-bold uppercase`,style:{color:xe(e.category).accent},children:[`[`,e.category,`]`]})}),(0,A.jsx)(`div`,{className:`text-sm sm:text-base font-bold text-slate-900 group-hover:text-[#003db3] transition font-['Lato']`,children:e.title}),(0,A.jsx)(`div`,{className:`text-xs text-slate-500 line-clamp-1 mt-1 font-['Lato'] font-normal`,children:e.subtitle})]}),(0,A.jsx)(re,{size:16,className:`text-slate-400 group-hover:text-[#003db3] group-hover:translate-x-0.5 transition shrink-0`})]},e.id)):(0,A.jsxs)(`div`,{className:`p-8 text-center text-slate-500 text-xs sm:text-sm font-mono`,children:[`NO_VECTORS_FOUND_FOR "`,i,`"`]})}),(0,A.jsxs)(`div`,{className:`bg-slate-50 px-4 py-2.5 border-t border-slate-200 text-xs text-slate-500 flex items-center justify-between font-mono font-medium`,children:[(0,A.jsx)(`span`,{children:`ESC to exit console`}),(0,A.jsxs)(`span`,{children:[n.length,` specifications in vector index`]})]})]})})},Oe=class extends S.Component{constructor(e){super(e),this.state={hasError:!1,error:null}}static getDerivedStateFromError(e){return{hasError:!0,error:e}}componentDidCatch(e,t){console.error(`Knowledge Base App caught error:`,e,t)}render(){return this.state.hasError?(0,A.jsxs)(`div`,{style:{padding:`40px`,fontFamily:`Lato, sans-serif`,maxWidth:`600px`,margin:`40px auto`,textAlign:`center`,background:`#090d16`,color:`#f8fafc`,border:`1px solid #1e293b`,borderRadius:`12px`},children:[(0,A.jsx)(`h2`,{style:{color:`#06b6d4`,fontSize:`20px`},children:`[ERR_KNOWLEDGE_BASE_RENDER]`}),(0,A.jsx)(`p`,{style:{marginTop:`10px`,color:`#94a3b8`,fontSize:`13px`},children:this.state.error?.message}),(0,A.jsx)(`button`,{onClick:()=>window.location.reload(),style:{marginTop:`20px`,padding:`8px 18px`,background:`#06b6d4`,color:`#090d16`,border:`none`,borderRadius:`6px`,cursor:`pointer`,fontWeight:`bold`},children:`RELOAD_SESSION`})]}):this.props.children}};function ke(){let[e,t]=(0,S.useState)(`All`),[n,r]=(0,S.useState)(!1),[i,a]=(0,S.useState)(null),[o,s]=(0,S.useState)(()=>localStorage.getItem(`ollawrite_theme`)||`light`);(0,S.useEffect)(()=>{document.documentElement.setAttribute(`data-theme`,o),localStorage.setItem(`ollawrite_theme`,o)},[o]);let c=()=>{s(e=>e===`light`?`dark`:`light`)};(0,S.useEffect)(()=>{let e=e=>{(e.metaKey||e.ctrlKey)&&e.key===`k`&&(e.preventDefault(),r(!0))};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[]);let l=e===`All`?ve:ve.filter(t=>t.category===e);return(0,A.jsx)(Oe,{children:(0,A.jsxs)(`div`,{className:`min-h-screen bg-white text-slate-900 flex flex-col font-['Lato'] selection:bg-[#dbe7ff] selection:text-[#002d86]`,children:[(0,A.jsx)(me,{activeCategory:e,onSelectCategory:t,onOpenSearch:()=>r(!0),theme:o,onToggleTheme:c}),(0,A.jsx)(`main`,{className:`flex-1`,children:i?(0,A.jsx)(Ee,{article:i,onBack:()=>a(null),onSelectArticle:a,allArticles:ve}):(0,A.jsx)(we,{articles:l,onReadArticle:a})}),(0,A.jsx)(De,{isOpen:n,onClose:()=>r(!1),articles:ve,onSelectArticle:e=>{a(e),r(!1)}})]})})}(0,k.createRoot)(document.getElementById(`root`)).render((0,A.jsx)(S.StrictMode,{children:(0,A.jsx)(ke,{})}));